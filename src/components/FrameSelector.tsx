...
// Currently empty as per previous request to remove predefined frames.
const AVAILABLE_FRAMES = [
    { id: 'eid_mubarak', url: '/frames/eid_mubarak.png', label: 'Eid Mubarak' },
];
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4">
                {AVAILABLE_FRAMES.length === 0 ? (
                    <div className="col-span-full py-10 text-center bg-slate-50 rounded-xl border border-dashed border-slate-200">
                        <p className="text-slate-400 italic">No frames available.</p>
                    </div>
                ) : (
